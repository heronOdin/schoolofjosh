...
const Auth: React.FC = () => {
  ...
  const { mutate: login, isPending: isLoggingIn,isError:isLoginError,error:loginError } = useLogin(navigate);
  const { mutate: register, isPending: isRegistering,isError:isRegisterError,error:registerError  } = useRegister(navigate);
